...
\label{sub:a_deliverable_1_spy_game}

Consider the following \href{https://www.mathworks.com/help/matlab/ref/spy.html}{\ul{spy}}-style plot of an information matrix (i.e., coefficient matrix in Gauss-Newton’s normal equations) for a landmark-based SLAM problem where dark cells correspond to non-zero blocks:\cite{VNAV}
